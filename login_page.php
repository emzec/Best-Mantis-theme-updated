...
# along with MantisBT.  If not, see <http://www.gnu.org/licenses/>.
	...
	echo '<div align="center" id="error">';
	...
	if ( $f_error ) {
		...
		echo '<p><font color="red">' . lang_get( 'login_error' ) . '</font></p>';
	}
	if ( $f_cookie_error ) {
...
<table class="width50" cellspacing="1" id="report-issue">
<tr>
	<td class="form-title" colspan="2">
		<?php
			...
			echo '<h3 class="new-issue-heading">'.lang_get( 'login_title' ).'</h3>' ?>
	</td>
	<td class="right">
	<?php
		if ( ON == config_get( 'allow_anonymous_login' ) ) {
...
<tr>
	<td class="center" colspan="2">
		<input type="submit" class="btn btn-primary" value="<?php echo lang_get( 'login_button' ) ?>" />
	</td>
</tr>
</table>
</form>
