...
function html_top_banner() {
	...
	if( !is_blank( $t_page ) && file_exists( $t_page ) && !is_dir( $t_page ) ) {
		...
		echo '<div align="', $t_align, '" class="header"><div class="header-holder">';
		if( $t_show_url ) {
		...
		echo '</div></div><div class="wrapper">';
	}
...
function html_login_info() {
	...
	echo '<table class="hide" style="border-bottom: 1px dotted #DADADA; margin-top: -9px; padding-bottom: 10px;">';
	echo '<tr>';
...
function html_footer( $p_file = null ) {
	...
	echo '<footer><div  class="footer"><div style="float:left;">';
	...
	echo "Copyright &copy; 2000 - ", date( 'Y' ), " MantisBT Team";
	...
	if( !is_page_name( 'login_page.php' ) && auth_is_user_authenticated() && !current_user_is_anonymous() ) {
		echo '<br><a href="mailto:', config_get( 'webmaster_email' ), '">', config_get( 'webmaster_email' ), '</a>';
	}
	...
	if ( !is_page_name( 'login_page' ) ) {
		...
		echo '<a href="http://www.emzec.com" title="Updated Mantis by emzec" style="display:block; float:left; padding:0px 10px 0px 0px; font:bold 26px arial; color:#DDD;  ">emzec';
		/*echo '<img src="' . helper_mantis_url( 'images/logo_emzec.png' ) . '" height="20" alt="Powered by Mantis Bugtracker" border="0" /></a>';*/
		echo '<a href="#" title="Free Web Based Bug Tracker"  style="display:block; float:right;">';
		
		echo '<img src="' . helper_mantis_url( 'images/mantis_logo.png' ) . '" height="35" alt="Powered by Mantis Bugtracker" border="0" /></a>';
...
function print_menu() {
	if( auth_is_user_authenticated() ) {
		...
		echo "<ul><li>" . implode("</li><li>", $t_menu_options) . "</li></ul>";
		/*echo '</td>';
		echo '<td class="menu right nowrap">';*/
		echo '</div><div class="menu-search">';
