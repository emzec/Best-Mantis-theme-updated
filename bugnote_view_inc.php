...
<tr class="bugnote" id="c<?php echo $t_bugnote->id ?>">
        <td class="<?php echo $t_bugnote_css ?>"> <hr size="1" color="#ddd">
		...
		<?php
			...
			if ( !bug_is_readonly( $f_bug_id ) ) {
				...
				if ( $t_can_edit_note || access_has_bug_level( config_get( 'update_bugnote_threshold' ), $f_bug_id ) ) {
					echo " [ ";
					print_link('bugnote_edit_page.php?bugnote_id='.$t_bugnote->id, lang_get( 'bugnote_edit_link' ));
					echo " ] ";
				...
				if ( $t_can_delete_note || access_has_bug_level( config_get( 'delete_bugnote_threshold' ), $f_bug_id ) ) {
					echo " [ ";
					print_link( 'bugnote_delete.php?bugnote_id='.$t_bugnote->id, lang_get( 'delete_link' ) );
				...
				if ( $t_can_edit_note || ( access_has_bug_level( config_get( 'update_bugnote_threshold' ), $f_bug_id ) &&
					...
					if ( VS_PRIVATE == $t_bugnote->view_state ) {
						echo " [ ";
						print_link( 'bugnote_set_view_state.php?private=0&bugnote_id=' . $t_bugnote->id, lang_get( 'make_public' ) );
						echo " ] ";
						#print_button( 'bugnote_set_view_state.php?private=0&bugnote_id=' . $t_bugnote->id, lang_get( 'make_public' ) );
					} else {
						echo " [ ";
						print_link( 'bugnote_set_view_state.php?private=1&bugnote_id=' . $t_bugnote->id, lang_get( 'make_private' ) );
						echo " ] ";
	...
	<!--<tr><td class="<?php echo $t_bugnote_note_css ?>">-->
		<?php /*
			switch ( $t_bugnote->note_type ) {
				case REMINDER:
					echo '<em>';
