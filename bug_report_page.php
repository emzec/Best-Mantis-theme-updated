...
<table class="width90" cellspacing="0" id="report-issue">
	<tr>
		<td class="form-title" colspan="4">
			<input type="hidden" name="m_id" value="<?php echo $f_master_bug_id ?>" />
			<input type="hidden" name="project_id" value="<?php echo $t_project_id ?>" />
			<?php #echo lang_get( 'enter_report_details_title' ) ?>
            <h3 class="new-issue-heading">Report New Issue</h3>
...
?>
	<tr <?php echo helper_alternate_class() ?>>
        ...
        <td class="category"><?php print_documentation_link( 'reproducibility' ) ?></td>
		<td>
			<?php if ( $tpl_show_reproducibility ) { ?>
...
<?php event_signal( 'EVENT_REPORT_BUG_FORM', array( $t_project_id ) ) ?>
	<tr <?php echo helper_alternate_class() ?>>
		...
		<td colspan="3">
			<input <?php echo helper_get_tab_index() ?> type="text" name="summary" size="78" maxlength="128" value="<?php echo string_attribute( $f_summary ) ?>" />
		</td>
	</tr>
	<tr <?php echo helper_alternate_class() ?>>
		<td class="category">
