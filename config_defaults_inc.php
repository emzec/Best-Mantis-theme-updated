...
# along with MantisBT.  If not, see <http://www.gnu.org/licenses/>.
	 ...
	 */
	$g_administrator_email	= 'administrator@studenthub.dk';

	/**
	 * Webmaster email
	 * @global string $g_webmaster_email
	 */
	$g_webmaster_email		= 'support@studenthub.dk';

	/**
	 * the sender email, part of 'From: ' header in emails
	 * @global string $g_from_email
	 */
 	$g_from_email			= 'bugs@studenthub.dk';

	/**
	 * the sender name, part of 'From: ' header in emails
	 * @global string $g_from_name
	 */
	$g_from_name			= 'StudentHub Bug Tracker';

	/**
	 * the return address for bounced mail
	 * @global string $g_return_path_email
	 */
	$g_return_path_email	= 'admin@studenthub.dk';
	 ...
	 */
	$g_status_colors		= array( 'new'			=> '#F0E68C', // red    (scarlet red #ef2929)
									 'feedback'		=> '#FFFACD', // purple (plum        #75507b)
									 'acknowledged'	=> '#FFE1FF', // orange (orango      #f57900)
									 'confirmed'	=> '#FFDAB9', // yellow (butter      #fce94f)
									 'assigned'		=> '#AFEEEE', // blue   (sky blue    #729fcf)
									 'resolved'		=> '#9AFF9A', // green  (chameleon   #8ae234)
